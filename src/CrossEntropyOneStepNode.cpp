...
CrossEntropyOneStepNode::CrossEntropyOneStepNode(int actCond, int obsToPredict,
		Node *parent, int mcTargetTimeStep) :
	OneStepNode(actCond, obsToPredict, parent, mcTargetTimeStep) {
}

CrossEntropyOneStepNode::~CrossEntropyOneStepNode() {
}
